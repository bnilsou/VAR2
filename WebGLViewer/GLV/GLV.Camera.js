...
GLV.Camera = function(){
    ...
    this.up = new Vec4(0.0, 100.0, 0.0, 0.0);
    ...
    this.mvMat.loadIdentity();
    this.mvMat.lookAt(this.pos, this.vrp, this.up);
};
...
GLV.Camera.prototype.move = function(direction){
    //this.mvMat.translate(direction);
    var mat = this.mvMat.copy();
    mat.transpose();
